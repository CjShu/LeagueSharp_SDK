    ...
    public static class Geometry
    {
        ...
        public class Polygon
        {
            ...
            public void Draw(Color color, int width = 1)
            {
                for (var i = 0; i <= Points.Count - 1; i++)
                {
                    ...
                    Utils.DrawLineInWorld(Points[i].ToVector3(), Points[nextIndex].ToVector3(), width, color);
                }
            }
        }
        ...
        public class Arc
        {
            ...
            public Polygon ToPolygon(int offset = 0)
            {
                ...
                var innerCenters = Common.Geometry.CircleCircleIntersection(Start, End, innerRadius, innerRadius);
                var outerCenters = Common.Geometry.CircleCircleIntersection(Start, End, outerRadius, outerRadius);
