namespace Flowers_Series.Common
{
    ...
    public static class Manager
    {
        ...
        {
            return OnlyBig ? GameObjects.Jungle.Where(x => x.IsValidTarget(Range, false, From) && (x.Name.Contains("Crab") || !GameObjects.JungleSmall.Contains(x))).ToList() : GameObjects.Jungle.Where(x => x.IsValidTarget(Range, false, From)).ToList();
        }
        ...
        {
            return Target?.GetRealAutoAttackRange() ?? 0f;
        }
        ...
        /// <returns></returns>
        private static double GetQAttackDamage(Obj_AI_Hero target)
        {
        ...
        {
            return Target != null && !Target.IsDead && !Target.IsZombie && Target.IsHPBarRendered;
        }
        ...
        /// Combo Key Active
        /// </summary>
        public static bool InCombo => Variables.Orbwalker.ActiveMode == LeagueSharp.SDK.Enumerations.OrbwalkingMode.Combo;

        /// <summary>
        /// Harass Key Active
        /// </summary>
        public static bool InHarass => Variables.Orbwalker.ActiveMode == LeagueSharp.SDK.Enumerations.OrbwalkingMode.Hybrid;

        /// <summary>
        /// LaneClear Key Active
        /// </summary>
        public static bool InClear => Variables.Orbwalker.ActiveMode == LeagueSharp.SDK.Enumerations.OrbwalkingMode.LaneClear;

        /// <summary>
        /// LastHit Key Active
        /// </summary>
        public static bool InLastHit => Variables.Orbwalker.ActiveMode == LeagueSharp.SDK.Enumerations.OrbwalkingMode.LastHit;

        /// <summary>
        /// None Key Active
        /// </summary>
        public static bool InNone => Variables.Orbwalker.ActiveMode == LeagueSharp.SDK.Enumerations.OrbwalkingMode.None;
        ...
        public static void WriteConsole(string Message, bool Chat = false)
        {
            ...
            if (Chat)
            {
                Game.PrintChat("Flowers' Series : " + Message);
            }
        }
        ...
        {
            switch (Program.Menu["Prediction"]["SelectPred"].GetValue<MenuList>().Index)
            {
                case 0:
                    {
                        if (CastToPosition)
                ...
                case 1:
                    {
                        ...
                        if (Spells.Speed != float.MaxValue && YasuoWindWall.CollisionYasuo(GameObjects.Player.ServerPosition, predput.CastPosition))
                        {
                            return;
                        }
                ...
                case 2:
                    {
                        ...
                        if (Spells.Speed != float.MaxValue && YasuoWindWall.CollisionYasuo(GameObjects.Player.ServerPosition, poutput2.CastPosition))
                        {
                            return;
                        }
