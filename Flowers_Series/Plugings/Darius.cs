namespace Flowers_Series.Plugings
{
    ...
    public static class Darius
    {
        ...
        public static void Init()
        {
            ...
            {
                RMenu.Add(new MenuSlider("Tolerance", "Damage Tolerance", 0, -100));
            }
        ...
        private static void JungleLogic()
        {
            ...
            if (mob != null && (mobs.Count > 0 && Menu["Darius_JungleClear"]["Q"] &&
                                                  Me.ManaPercent >= Menu["Darius_JungleClear"]["Mana"].GetValue<MenuSlider>().Value 
                                                  && mob.Health > Me.GetRealAutoAttackRange()))
            {
                Q.Cast();
            }
        }
        ...
        private static void OnDoCast(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs Args)
        {
            ...
            if (InCombo)
            {
                if (Menu["Darius_Combo"]["W"] && Args.Target is Obj_AI_Hero && W.IsReady())
                {
        ...
        private static bool QOutSide(Obj_AI_Hero target)
        {
        ...
        private static int GetPassiveCount(Obj_AI_Hero target)
        {
