    ...
    public class Illaoi
    {
        ...
        public static void Init()
        {
            ...
            var EBlacklist = Menu.Add(new Menu("Illaoi_EBlackList", "E BlackList"));
            {
                ...
                if (GameObjects.EnemyHeroes.Any())
                {
                    GameObjects.EnemyHeroes.ForEach(i => EBlacklist.Add(new MenuBool(i.ChampionName.ToLower(), i.ChampionName)));
                }
            }
        ...
        private static void Combo()
        {
            ...
            {
                if (Q.IsReady() && Menu["Illaoi_Combo"]["Q"] && Menu["Illaoi_Combo"]["QGhost"])
                {
                    Q.CastTo(Ghost); ;
                }
            }
        ...
        private static void KillSteal()
        {
            ...
            {
                var qt = GameObjects.EnemyHeroes.FirstOrDefault(x => x.IsValidTarget(Q.Range) && x.Health < Q.GetDamage(x));
            ...
            {
                var et = GameObjects.EnemyHeroes.FirstOrDefault(x => !Menu["Illaoi_EBlackList"][x.ChampionName.ToLower()] && x.IsValidTarget(E.Range) && x.Health < E.GetDamage(x));
            ...
            {
                var rt = GameObjects.EnemyHeroes.FirstOrDefault(x => x.IsValidTarget(R.Range - 50) && x.Health < R.GetDamage(x) && Menu["Illaoi_KillSteal"][x.ChampionName.ToLower()]);
