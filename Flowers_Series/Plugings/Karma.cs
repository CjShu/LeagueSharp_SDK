namespace Flowers_Series.Plugings
{
    ...
    public class Karma
    {
        ...
        private static int SwitchETickCount, SwitchRTickCount;
        ...
        public static void Init()
        {
            ...
            var MiscMenu = Menu.Add(new Menu("Karma_Misc", "Misc"));
            {
                ...
                MiscMenu.Add(new MenuBool("Support", "Support Mode!"));
            }
        ...
        private static void OnDraw(EventArgs args)
        {
            ...
            if (Menu["Karma_Draw"]["Auto"])
            {
                ...
                text = Menu["Karma_Harass"]["Auto"].GetValue<MenuKeyBind>().Active ? "On" : "Off";
            ...
            if (Menu["Karma_Draw"]["ComboE"])
            {
                ...
                switch (Menu["Karma_Combo"]["E"].GetValue<MenuList>().Index)
                {
                    case 0:
                        text = "Low Hp!";
                        break;
            ...
            if (Menu["Karma_Draw"]["ComboR"])
            {
                ...
                switch (Menu["Karma_Combo"]["R"].GetValue<MenuList>().Index)
                {
                    case 0:
                        text = "All!";
                        break;
        ...
        private static void Jungle()
        {
            ...
            if (Mobs.Count > 0)
            {
                ...
                if (Me.ManaPercent >= Menu["Karma_JungleClear"]["Mana"].GetValue<MenuSlider>().Value)
                {
                    ...
                    if (mob != null && (Menu["Karma_JungleClear"]["E"] && W.IsReady() && mob.IsAttackingPlayer))
                    {
                        E.Cast(Me);
                    }
                }
