    ...
    public static class Twitch
    {
        ...
        public static void Init()
        {
            ...
            var Harass = Menu.Add(new Menu("Twitch_Harass", "Harass"));
            {
                ...
                Harass.Add(new MenuSlider("HarassWMana", "Min Mana Percent", 60));
                Harass.Add(new MenuBool("HarassE", "Use E", true));
                Harass.Add(new MenuSlider("HarassEMin", "Min Stacks Counts", 2, 1, 6));
                Harass.Add(new MenuSlider("HarassEMana", "Min Mana Percent", 60));
            }
        ...
        private static void OnProcessSpellCast(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs Args)
        {
            ...
            {
                if (sender.IsMe && PlayerIsKillTarget && Q.IsReady() && Me.CountEnemyHeroesInRange(850) >= 1)
                {
                    Q.Cast();
                }
            }
        ...
        private static void OnDoCast(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs Args)
        {
            if (Menu["Twitch_Misc"]["AutoYoumuu"] &&
                ...
                Variables.Orbwalker.GetTarget() is Obj_AI_Hero && Me.HasBuff("TwitchFullAutomatic"))
            {
