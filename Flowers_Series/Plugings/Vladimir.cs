    ...
    public class Vladimir
    {
        ...
        public static void Init()
        {
            ...
            var ComboMenu = Menu.Add(new Menu("Vladimir_Combo", "Combo"));
            {
                ...
                ComboMenu.Add(new MenuBool("Attack", "Disable AutoAttack In Combo Mode"));
            }
            ...
            {
                FleeMenu.Add(new MenuBool("Q", "Use Q"));
        ...
        private static void KillSteal()
        {
            ...
            {
                var et = GameObjects.EnemyHeroes.FirstOrDefault(x => x.IsValidTarget(E.Range) && x.Health < E.GetDamage(x));
            ...
            {
                var rt = GameObjects.EnemyHeroes.FirstOrDefault(x => x.IsValidTarget(R.Range) && x.Health < R.GetDamage(x) && Menu["Vladimir_KillSteal"][x.ChampionName.ToLower()]);
        ...
        private static void OnDraw(EventArgs args)
        {
            ...
            if (Menu["Vladimir_Draw"]["Auto"])
            {
                ...
                text = Menu["Vladimir_Harass"]["Auto"].GetValue<MenuKeyBind>().Active ? "On" : "Off";

                Drawing.DrawText(Me.HPBarPosition.X + 30, Me.HPBarPosition.Y - 40, System.Drawing.Color.Red, "Auto Q (" + Menu["Vladimir_Harass"]["Auto"].GetValue<MenuKeyBind>().Key + "): ");
