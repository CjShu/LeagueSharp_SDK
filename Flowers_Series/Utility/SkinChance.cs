namespace Flowers_Series.Utility
{
    ...
    internal class SkinChance
    {
        ...
        public static void Inject()
        {
            ...
            {
                SkinMenu.Add(new MenuBool("Enable", "Enabled"));
                ...
                switch (Me.ChampionName)
                {
                    ...
                    case "Karma":
                        ...
                        break;
                    case "Morgana":
                        SkinMenu.Add(new MenuList<string>("SkinName", "Select Skin", Morgana));
                        break;
                    case "Riven":
        ...
        private static readonly IEnumerable<string> Ahri = new[]
        {
            "Classic", "Dynasty Ahri", "Midnight Ahri", "Foxfire Ahri", "Popstar Ahri", "Challenger Ahri", "Academy Ahri", "Arcade Ahri"
        };

        private static readonly IEnumerable<string> Akali = new[]
        {
        ...
        private static readonly IEnumerable<string> Ashe = new[]
        {
        ...
        private static readonly IEnumerable<string> Blitzcrank = new[]
        {
        ...
        private static readonly IEnumerable<string> Darius = new[]
        {
        ...
        private static readonly IEnumerable<string> Ezreal = new[]
        {
        ...
        private static readonly IEnumerable<string> Graves = new[]
        {
            "Classic", "Hired Gun Graves", "Jailbreak Graves", "Mafia Graves", "Riot Graves", "Pool Party Graves", "Cutthroat Graves"
        };

        private static readonly IEnumerable<string> Hecarim = new[]
        {
        ...
        private static readonly IEnumerable<string> Illaoi = new[]
        {
        ...
        private static readonly IEnumerable<string> Karma = new[]
        {
        ...
        private static readonly IEnumerable<string> Morgana = new[]
        {
        ...
        private static readonly IEnumerable<string> Riven = new[]
        {
        ...
        private static readonly IEnumerable<string> Sivir = new[]
        {
        ...
        private static readonly IEnumerable<string> Tristana = new[]
        {
        ...
        private static readonly IEnumerable<string> TwistedFate = new[]
        {
        ...
        private static readonly IEnumerable<string> Twitch = new[]
        {
        ...
        private static readonly IEnumerable<string> Vayne = new[]
        {
        ...
        private static readonly IEnumerable<string> Viktor = new[]
        {
            "Classic", "Full Machine Viktor", "Prototype Viktor", "Creator Viktor"
        };

        private static readonly IEnumerable<string> Vladimir = new[]
        {
