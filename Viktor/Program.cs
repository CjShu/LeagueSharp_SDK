namespace Flowers_Viktor
{
    ...
    class Program
    {
        private static Obj_AI_Hero Me, Target = null;
        ...
        private static void Load(object sender, EventArgs e)
        {
            ...
            Game.PrintChat(Me.ChampionName + " : This is Old Version and i dont update it anymore, Please Use Flowers' Series!");
        ...
        private static float GetComboDamage(Obj_AI_Hero e)
        {
            float Damage = 0f;
        ...
        private static void CastIgnite(Obj_AI_Hero e)
        {
        ...
        private static bool CastW(Obj_AI_Hero target)
        {
        ...
        private static bool CastE(Obj_AI_Hero target)
        {
            if (target != null && target.IsHPBarRendered)
            {
        ...
        private static void CastR(Obj_AI_Hero e)
        {
        ...
        private static float GetReadyComboDamage(Obj_AI_Hero e)
        {
            float damage = 0f;
        ...
        private static double GetQAttackDamage(Obj_AI_Hero e)
        {
        ...
        private static double GetIgniteDamage(Obj_AI_Hero e)
        {
